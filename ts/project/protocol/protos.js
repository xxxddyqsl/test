...
module.exports = {
    ...
    MakeReqHeader: function (sequence, session, token) {
        var client2server_pb = require('client2server_pb');
        if (client2server_pb == null || !client2server_pb) {
    ...
    NewProtoObjectArray:function(name) {
        var client2server_pb = require('client2server_pb');
        if (client2server_pb == null || !client2server_pb) {
    ...
    ParseProtoRsp: function (cmdid, body) {
        var client2server_pb = require('client2server_pb');
        if (client2server_pb == null || !client2server_pb) {
            return null;
        }
