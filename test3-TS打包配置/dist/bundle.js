...
function MakeRtcClient() {
    return (0, RtcClientImpl_1.NewRtcClient)();
}
...
var default_http_server_url = "http://172.18.70.30:24002";
var sdk_version = "111111";
...
var obj_name_msg = "object_msg";
var obj_notify_header = "notify_header";
...
function trimMediaType(org) {
    ...
    var sub1 = org.substr(clen - 5);
    if (sub1 == "_data") {
        return org.substr(0, clen - 5);
    }
    if (clen > 6) {
        var sub2 = org.substr(clen - 6);
        if (sub2 == "_audio" || sub2 == "_video") {
            return org.substr(0, clen - 6);
        }
    }
    if (clen > 8) {
        var sub3 = org.substr(clen - 8, 6);
        if (sub3 == "_video") {
...
var ParseParameter = /** @class */ (function () {
    ...
    ParseParameter.prototype.getStr = function () {
        return this._str;
    };
...
var RtcClientImpl = /** @class */ (function () {
    ...
    RtcClientImpl.prototype.sendMsg = function (msg, msgLen, clientId, token) {
        var req = ProtoHelper.NewProtoReq(Protos.Protocol.cmd_notify_sendmsg);
        var header = ProtoHelper.NewProtoObject(obj_notify_header);
        var body = ProtoHelper.NewProtoObject(obj_name_msg);
        var msgList = req.getMsgList();
        header.setFrom(Utils_1.default.base64Encode(this._clientid));
        header.setTo(Utils_1.default.base64Encode(clientId));
        body.setClientkey(Utils_1.default.base64Encode(this._clientKey));
        if (token && token != "") {
            body.setToken(Utils_1.default.base64Encode(token));
        }
        body.setMsgdata(Utils_1.default.base64Encode(msg));
        msgList.push(body);
        req.setMsgList(msgList);
        var btReq = Packeted.Packeter.PackMsgReq(Protos.Protocol.cmd_notify_sendmsg, header, req);
        this._socket.send(btReq);
        return 0;
    };
    RtcClientImpl.prototype.pauseSend = function (bPause, streamType, clientId) {
        var peerid = '';
    ...
    RtcClientImpl.prototype.onSucceed = function (type, sdp, peerid) {
        ...
        if (!peer.bGotLocalParams) {
            ...
            this._peers.set(peerid, peer);
            var par = this._pEngine.getLocalParamsForPeer();
            rtc.setPeerParams(Utils_1.default.base64Encode(par)); // base64Encode 必须
        }
    ...
    RtcClientImpl.prototype.getRemoteAudioIds = function () {
        return this._pEngine.getOnlyRemoteAudios();
    };
    RtcClientImpl.prototype.setRemoteAudio = function (sClientId, audio) {
        console.log("RtcClientImpl setRemoteVideo sClientId=", sClientId);
    ...
    RtcClientImpl.prototype.OnMessage = function (pkt) {
        if (pkt.cmdid != 1) {
            if (pkt.rspHeader) {
                console.log("RtcClientImpl OnMessage cmd=", pkt.cmdid, ",msgType=", pkt.msgType, ",rspHeader=", pkt.rspHeader, ",pb=", pkt.pb);
            }
            else {
                console.log("RtcClientImpl OnMessage cmd=", pkt.cmdid, ",msgType=", pkt.msgType, ",pb=", pkt.pb);
            }
        }
    ...
    RtcClientImpl.prototype.setAuthoKey = function (authkey) {
    ...
    RtcClientImpl.prototype.login = function (clientKey, roomKey, tLoginParam) {
        ...
        this._waitRelogin = false;
        this._bNetDisable = false;
        console.log("RtcClientImpl login====> client ", clientKey, " login to room ", roomKey, ", login param bAutoRelogin=", this._attr.bAutoRelogin, ",bNotifyFlag=", this._attr.bNotifyFlag, ",bOrderFlag=", this._attr.bOrderFlag, ",bP2pFlag=", this._attr.bP2pFlag, ",bSupportVideo=", this._attr.bSupportVideo, ",bSupportOfflines=", this._attr.bSupportOfflines);
        this._loadConfig();
        return 0;
    };
    ...
    RtcClientImpl.prototype.publish = function (sendFlag, sendType, clientId) {
        if (this._onSend) {
            return 1024;
        }
        var peerid = '';
    ...
    RtcClientImpl.prototype._loadConfig = function () {
        ...
        var href = this._m_domain + "?" + params.join("&");
    ...
    RtcClientImpl.prototype._socketOpen = function () {
        ...
        var srvAddr = "ws://" + this._servers[0]; //for online
    ...
    RtcClientImpl.prototype._login = function () {
        ...
        var addrs = this._servers[0].split(":");
    ...
    RtcClientImpl.prototype._onRegesterRsp = function (rspHeader, pb) {
        ...
        var VideodftSendParam = {
            dbgSendFlag: false,
            disableUi: false,
            waitResp: 0,
            changed: false,
        };
        var Video1dftSendParam = {
            dbgSendFlag: false,
            disableUi: false,
            waitResp: 0,
            changed: false,
    ...
    RtcClientImpl.prototype._onNotifyWebrtcCmd = function (pb) {
        ...
        var mline = Utils_1.default.uint8ToString(rtcmsg.getMline());
    ...
    RtcClientImpl.prototype._onNotifyBindStreams = function (pb) {
        ...
        for (var _a = 0, newMedias_1 = newMedias; _a < newMedias_1.length; _a++) {
            ...
            console.log("_onNotifyBindStreams::onAddStream bindId= ", media.bindId, " streamType= ", media.streamType, " streamid= ", media.streamId, " token= ", media.token);
    ...
    RtcClientImpl.prototype._commitMediaAttrChanged = function (pf) {
    ...
    RtcClientImpl.prototype._sendMediaAttrChanged = function (pf, iType) {
        if (this.isP2p()) {
        ...
        if (iType == Entity.EStreamType.kVideo) {
            ...
            if (vs.width * vs.height > 0) {
                ...
                attrs.push(attr);
                attr = ProtoHelper.NewProtoObject(obj_name_keyvalue);
                attr.setKey(Utils_1.default.base64Encode("fps"));
                attr.setValue(Utils_1.default.base64Encode(vs.fps.toString()));
                attrs.push(attr);
                ...
                var attr = ProtoHelper.NewProtoObject(obj_name_keyvalue);
                attr.setKey(Utils_1.default.base64Encode("w"));
                attr.setValue(Utils_1.default.base64Encode("0"));
                attrs.push(attr);
                attr = ProtoHelper.NewProtoObject(obj_name_keyvalue);
                attr.setKey(Utils_1.default.base64Encode("h"));
                attr.setValue(Utils_1.default.base64Encode("0"));
            ...
            media.setName(Utils_1.default.base64Encode("audio"));
    ...
    RtcClientImpl.prototype._onNotifySendMsg = function (pb) {
        var header = pb.header;
        var body = pb.body;
        var msgs = body.getMsgList();
        var from = Utils_1.default.uint8ToString(header.getFrom());
        for (var i = 0; i < msgs.length; i++) {
            var msg = msgs[i];
            var clientKey = Utils_1.default.uint8ToString(msg.getClientkey());
            var data = Utils_1.default.uint8ToString(msg.getMsgdata());
            var token = Utils_1.default.uint8ToString(msg.getToken());
            var event_2 = new BaseEventImpl();
            var evetnId = Protos.EEventId.ntf_recv_msg;
            event_2.setEventId(evetnId);
            event_2.put(Protos.EEventKey.eKeyClientID, from);
            event_2.put(Protos.EEventKey.eKeyClientKey, clientKey);
            event_2.put(Protos.EEventKey.eKeyToken, token);
            event_2.put(Protos.EEventKey.eKeySize, data.length);
            event_2.put(Protos.EEventKey.eKeyData, data);
            console.log("commitSimpleEvent eventId=", evetnId, event_2);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RtcEngineImpl = exports.TAudioToken = exports.TVideoToken = exports.RtcPeerImpl = void 0;
...
var RtcPeerImpl = /** @class */ (function () {
    function RtcPeerImpl(csid, bSendOffer, engine, pm) {
        ...
        this._peer_connect_setCfg = null;
        this._engine = null;
        this._video_streams = {};
        this._audio_streams = {};
        ...
        if (-1 == csid.lastIndexOf("getCfg")) {
            ...
            this._peer_connect.ontrack = function (ev) {
                if (!(ev && ev.streams)) {
                    return;
                }
                if (ev.track.kind == "audio") {
                    var stream_audio = ev.streams[0];
                    _this._audio_streams[ev.track.id] = stream_audio;
                    var csid_1 = _this._csid;
                    var type_1 = Entity.EStreamType.kAudio;
                    _this._param.pSink.onAddStream(stream_audio.id, type_1, ev.track.id, csid_1);
                    console.log("RtcPeerImpl::_peer_connect ontrack kind: ", ev.track.kind, " trackid: ", ev.track.id, " this_csid: ", _this._csid);
                    return;
                }
                var stream_video = ev.streams[0];
                _this._video_streams[ev.track.id] = stream_video;
                var id = _this._csid;
                console.log("RtcPeerImpl::_peer_connect ontrack kind: ", ev.track.kind, " trackid: ", ev.track.id, " this_csid: ", _this._csid, " streamID: ", stream_video.id);
                var type = Entity.EStreamType.kVideo;
                _this._param.pSink.onAddStream(stream_video.id, type, ev.track.id, id);
            };
            if (bSendOffer) {
            ...
            this._peer_connect_setCfg.onicecandidate = function (ev) {
                if (null != ev.candidate) {
                    ...
                    if (ev.candidate.sdpMLineIndex == 11111) {
                        ...
                        var res = ev.candidate.sdpMid;
                        console.log("INDEX_TYPE_SET_PARAMS res: ", res);
                        if (-1 != res.lastIndexOf("localparam")) {
                            var resss = res.split("localparam:");
                            var par = resss[1];
                            _this._peerPar = par; // HXY   这个参数会导致SetLocal失败
                            console.log("onicecandidate peerPar: ", _this._peerPar);
                            return;
                        }
                        else if (-1 != res.lastIndexOf("deviceinf")) {
                            var resss = res.split("deviceinf:");
                            var par = resss[1];
                            _this._devInfoPar = par;
                            console.log("onicecandidate devInfoPar: ", _this._devInfoPar);
                            return;
                        }
                        else {
                            return;
            ...
            this._peer_connect_setCfg.ontrack = function (ev) {
                return;
            };
    ...
    RtcPeerImpl.prototype.getRemoteVideoStream = function (token) {
        return this._video_streams[token];
    };
    RtcPeerImpl.prototype.getRemoteAudioStream = function (token) {
        return this._audio_streams[token];
    };
    RtcPeerImpl.prototype.onSucceed = function (s) {
    ...
    RtcPeerImpl.prototype.onCreateSdpSucceed = function (sdptype, s) {
    ...
    RtcPeerImpl.prototype.onFailed = function (sdptype, reason) {
    ...
    RtcPeerImpl.prototype.setPeerParams = function (params) {
        var sdp = "candidate:1187091188 1 udp 2063597568 172.18.70.30 4005 typ host generation 0 network-id 3";
        var type = 11111;
        var Par = "SetPeerParams:" + "remote:" + params;
        console.log("_peer_connect_setCfg addIceCandidate SetPeerParams= ", Par);
        var ice = { candidate: sdp, sdpMLineIndex: type, sdpMid: Par };
        this._peer_connect.addIceCandidate(ice);
    };
    RtcPeerImpl.prototype.setPeerKeyValueParams = function (key, value) {
        var sdp = "candidate:1187091188 1 udp 2063597568 172.18.70.30 4005 typ host generation 0 network-id 3";
        var type = 11111;
        var Par = key + ":" + value;
    ...
    RtcPeerImpl.prototype.setLocalPeerParams = function (params) {
        var sdp = "candidate:1187091188 1 udp 2063597568 172.18.70.30 4005 typ host generation 0 network-id 3";
        var Par = "SetPeerParams:" + "local:" + params;
        console.log("_peer_connect_setCfg addIceCandidate setLocalPeerParams= ", Par);
        var type = 11111;
        var ice = { candidate: sdp, sdpMLineIndex: type, sdpMid: Par };
        this._peer_connect.addIceCandidate(ice);
    };
    RtcPeerImpl.prototype.getPeerParams = function (params) {
        var sdp2 = "candidate:1187091188 1 udp 2063597568 172.18.70.30 4005 typ host generation 0 network-id 3";
        var type = 11112;
        var ice2 = { candidate: sdp2, sdpMLineIndex: type, sdpMid: params };
    ...
    RtcPeerImpl.prototype.getPeerPar = function () {
        console.log("getPeerPar _peerPar", this._peerPar);
        return this._peerPar;
    };
    RtcPeerImpl.prototype.getPeerDeviceInfo = function () {
...
;
var TAudioToken = /** @class */ (function () {
    function TAudioToken() {
        this.audio = null;
        this.stream = null;
        this.peer = null;
    }
...
exports.TAudioToken = TAudioToken;
;
var RtcEngineImpl = /** @class */ (function () {
    function RtcEngineImpl() {
        ...
        this._peers = {};
        this._peers_cfg = {};
        this._local_peer_par = "";
        this._local_peerDevInfo_par = "";
        var peer = new RtcPeerImpl("getCfg", false, this, this._param);
    ...
    RtcEngineImpl.prototype.setLocalStreams = function (localstream, screenflag) {
        ...
        for (var _i = 0, _a = Object.keys(this._peers); _i < _a.length; _i++) {
            var key = _a[_i];
    ...
    RtcEngineImpl.prototype.videoSize = function (small) {
        ...
        if (this._screen_flag) {
            if (small)
                return null;
            var vSize = { width: 160, height: 320, fps: 20 };
            while (true) {
    ...
    RtcEngineImpl.prototype.onAddStream = function (streamid, streamtype, token, csid, peer) {
        ...
        if (streamtype == Entity.EStreamType.kAudio) {
            var Astream = peerImpl.getRemoteAudioStream(token);
            if (null == Astream) {
                console.log("onAddStream getRemoteAudioStream not found");
                return;
            }
            var tk_1 = this._remote_audios[csid];
            if (null == tk_1) {
                tk_1 = new TAudioToken();
                tk_1.peer = peer;
                tk_1.stream = Astream;
                this._remote_audios[csid] = tk_1;
            }
            else {
                tk_1.peer = peer;
                tk_1.stream = Astream;
                if (null != tk_1.audio)
                    tk_1.audio.srcObject = Astream;
            }
            return;
        }
        var stream = peerImpl.getRemoteVideoStream(token);
        if (null == stream) {
    ...
    RtcEngineImpl.prototype.getOnlyRemoteAudios = function () {
        var res = [];
        for (var _i = 0, _a = Object.keys(this._remote_audios); _i < _a.length; _i++) {
            var key = _a[_i];
            res.push(key);
        }
        return res;
    };
    RtcEngineImpl.prototype.setOnlyRemoteAudio = function (audioID, audio) {
        console.log("RtcEngineImpl::setOnlyRemoteAudio audioID= ", audioID);
        if (null == audio)
            return;
        var tk = this._remote_audios[audioID];
        if (tk == null) {
            tk = new TAudioToken();
            tk.audio = audio;
...
var Packeter = /** @class */ (function () {
    ...
    Packeter.PackMsgReq = function (cmd, header, msg) {
        var btHeader;
        var headerLen = 0;
        var btBody = new Uint8Array(0);
        var bodyLen = 0;
        var tmp = Packeter.PackData(header);
        if (tmp) {
            btHeader = tmp;
    ...
    Packeter.ParseRsp = function (data) {
        ...
        //header is not rspHeader
        if (cmdid == 200) {
            var pbHeader_1 = ProtoHelper.ParseNotifyHeader(btHeader);
            if (!pbHeader_1) {
                throw "ParseRsp Notify Header error";
            }
            if (bodyLen > 0) {
                ...
                rsp.pb = { header: pbHeader_1, body: pbBody };
            }
            else {
                rsp.pb = { header: pbHeader_1, body: null };
            }
            return rsp;
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Base64D = exports.Base64E = exports.MakeNumberUint8Array = exports.MakeReqHeader = exports.NewReqHeader = exports.ParseNotifyHeader = exports.ParseRspHeader = exports.ParseProtoRsp = exports.NewProtoObjectArray = exports.NewProtoObject = exports.NewProtoReq = void 0;
...
function ParseNotifyHeader(body) {
    return protos.ParseNotifyHeader(body);
}
exports.ParseNotifyHeader = ParseNotifyHeader;
...
(function (Protocol) {
    ...
    Protocol[Protocol["cmd_notify_sendmsg"] = 200] = "cmd_notify_sendmsg";
...
(function (EEventId) {
    ...
    EEventId[EEventId["ntf_recv_msg"] = 63] = "ntf_recv_msg";
...
(function (EEventKey) {
    ...
    EEventKey[EEventKey["eKeyToken"] = 9] = "eKeyToken";
    EEventKey[EEventKey["eKeySize"] = 10] = "eKeySize";
    EEventKey[EEventKey["eKeyData"] = 11] = "eKeyData";
    EEventKey[EEventKey["eKeyRoomID"] = 12] = "eKeyRoomID";
    EEventKey[EEventKey["eKeyAppType"] = 13] = "eKeyAppType";
    EEventKey[EEventKey["eKeyAppKey"] = 14] = "eKeyAppKey";
    EEventKey[EEventKey["eKeyParams"] = 15] = "eKeyParams";
...
/**
 * optional sint32 disabled = 3;
 * @return {number}
 */
proto.snail_video.media.object_media.prototype.getDisabled = function() {
  return /** @type {number} */ (jspb.Message.getFieldProto3(this, 3, 0));
};


/** @param {number} value  */
proto.snail_video.media.object_media.prototype.setDisabled = function(value) {
  jspb.Message.setField(this, 3, value);
};
